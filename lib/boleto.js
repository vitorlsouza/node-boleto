...
var Boleto = function (options) {
  ...
  this['pagador_banco'] = formatters.htmlString(this['pagador_banco'])
  this['instrucoes'] = formatters.htmlString(this['instrucoes'])
  this['instrucoes_banco'] = formatters.htmlString(this['instrucoes_banco'])
  this['unidade'] = formatters.htmlString(this['unidade'])
